...
void ft5426_init(void)
{
    ...
    /* 初始化INT引脚，使能中断 */
    IOMUXC_SetPinMux(IOMUXC_GPIO1_IO09_GPIO1_IO09, 0);//复用为GPIO1-IO09
    ...
    /* 初始化RST引脚，使能中断 */
    IOMUXC_SetPinMux(IOMUXC_SNVS_SNVS_TAMPER9_GPIO5_IO09, 0);//复用为GPIO5-IO09
    ...
    ft5426_write_byte(FT5426_ADDR, FT5426_DEVICE_MODE, 0);  /* 设置FT5426在正常工作模式 */
